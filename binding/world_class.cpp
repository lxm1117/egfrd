...
namespace binding {
    ...
    struct particle_id_pair_range_select_first_converter
    {
        ...
        struct to_native_converter
        {
            ...
            {
                data->stage1.convertible = new(data->storage.bytes) native_type(*reinterpret_cast<wrapper_type*>(data->stage1.convertible)->ptr());
            }
        };
    ...
    void register_world_class()
    {
        ...
        particle_id_pair_range_select_first_converter<get_select_first_range<World::particle_id_pair_range>::type>::__register();
