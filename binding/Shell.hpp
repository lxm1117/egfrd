...
namespace binding {
    ...
    public:
        ...
        static PyObject* __new__(PyTypeObject* klass, PyObject* arg, PyObject* kwarg)
        {
            ...
            case 2:
                retval = create();
                if (set_did(reinterpret_cast<ShellWrapper*>(retval), PyTuple_GetItem(arg, 0), 0)
                    || set_shape(reinterpret_cast<ShellWrapper*>(retval), PyTuple_GetItem(arg, 1), 0))
                {
        ...
        {
            return boost::python::incref(boost::python::object(self->impl_.did()).ptr());
        }
