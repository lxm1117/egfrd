...
namespace binding {
    ...
    struct MatrixSpaceExtrasBase
    {
        ...
        struct add_const_if : boost::mpl::if_ < boost::is_const<Tref_>, typename boost::add_const<T_>::type, T_ > {};

        template<typename Tpair_>
        struct select1st : public std::unary_function < Tpair_&, typename add_const_if<typename Tpair_::first_type, Tpair_>::type& >
        {
            typename add_const_if<typename Tpair_::first_type, Tpair_>::type&
        ...
        private:
            struct to_ndarray_converter
            {
                static PyObject* convert(const result_type& val)
                {
                    ...
                    PyObject* retval = PyArray_NewFromDescr(&PyArray_Type, result_type_descr_, 1, const_cast<npy_intp*>(dims), nullptr,
                        val.size() ? &const_cast<result_type&>(val)[0] : nullptr, NPY_CARRAY, nullptr);
    ...
    public:
        ...
        public:
            ...
            {
            public:
                inline collector(typename Builders::result_type& result) : result_(result) {}

                inline void operator()(typename impl_type::iterator const& i, const typename position_type::value_type& d) const
                {
                    result_.push_back(result_element(boost::python::incref(boost::python::object(*i).ptr()), d));
                }

                inline void operator()(typename impl_type::const_iterator const& i, const typename position_type::value_type& d) const
                {
                    result_.push_back(result_element(boost::python::incref(boost::python::object(*i).ptr()), d));
                }
            ...
            public:
                inline all_neighbors_collector(typename Builders::result_type& result, const distance_functor& distance)
                    : result_(result), distance_(distance) {}
                ...
                inline void operator()(typename impl_type::iterator i, const position_type& d) const
                {
                    result_.push_back(result_element(
                        boost::python::incref(boost::python::object(*i).ptr()),
                ...
                inline void operator()(typename impl_type::const_iterator const& i, const position_type& d) const
                {
                    result_.push_back(result_element(
                        boost::python::incref(boost::python::object(*i).ptr()),
                        distance_(offset(shape((*i).second), d))));
            ...
            struct distance_comparator : public std::binary_function < result_element, result_element, bool >
            {
        ...
        public:
            inline static void build_neighbors_array(result_type& retval, impl_type const& cntnr, ::Sphere<length_type> const& sphere)
            {
            ...
            inline static void build_neighbors_array_cyclic(result_type& retval, impl_type const& cntnr, const ::Sphere<length_type>& sphere)
            {
                collector col(retval);
            ...
            inline static void build_all_neighbors_array(result_type& retval, impl_type const& cntnr, const position_type& pos)
            {
            ...
            inline static void build_all_neighbors_array_cyclic(result_type& retval, impl_type const& cntnr, const position_type& pos)
            {
        ...
        typedef boost::transform_iterator<select1st<const typename impl_type::const_iterator::value_type>, typename impl_type::const_iterator> key_iterator;

    public:
        static boost::python::object __iter__(boost::python::back_reference<impl_type const&> self)
        {
            using namespace boost::python;
            return object(handle<>(peer::wrappers::stl_iterator_wrapper<typename impl_type::const_iterator, boost::python::object>::create(
                std::make_pair(self.get().begin(), self.get().end()), self.source())));
        }

        static boost::python::object iterkeys(boost::python::back_reference<impl_type const&> self)
        {
            using namespace boost::python;
            return object(handle<>(peer::wrappers::stl_iterator_wrapper<key_iterator, boost::python::object>::create(
                make_transform_iterator_range(std::make_pair(self.get().begin(), self.get().end()),
                select1st<const typename impl_type::const_iterator::value_type>()), self.source())));
        }

        typename Builders::result_type
            static get_neighbors_within_radius_cyclic(impl_type const& impl, const position_type& pos, length_type radius)
        {
            ...
            Builders::build_neighbors_array_cyclic(retval, impl, ::Sphere<length_type>(pos, radius));
        ...
        static const mapped_type& __getitem__(impl_type const& impl, key_type const& k)
        {
            ...
            if (i == impl.end())
            {
                PyErr_SetObject(PyExc_KeyError, boost::python::incref(boost::python::object(k).ptr()));
    ...
    inline void register_matrix_space_class(char const* class_name)
    {
        ...
        peer::converters::register_tuple_converter<typename extras_type::impl_type::value_type>();
        peer::wrappers::stl_iterator_wrapper<typename extras_type::impl_type::const_iterator, boost::python::object>::__class_init__((_class_name + ".iterator").c_str());
        peer::wrappers::stl_iterator_wrapper<typename extras_type::key_iterator, boost::python::object>::__class_init__((_class_name + ".keyiterator").c_str());

        // defining the python class for the matrix space
        class_<impl_type>(class_name, init<typename impl_type::length_type, typename impl_type::size_type>())
            ...
            .def("get_neighbors_within_radius_cyclic", &extras_type::get_neighbors_within_radius_cyclic)
            .def("get_neighbors_within_radius", &extras_type::get_neighbors_within_radius_cyclic)
            ...
            .def("__getitem__", &extras_type::__getitem__, return_value_policy<copy_const_reference>())
