...
namespace binding {
    ...
    public:
        ...
        struct to_native_converter
        {
            ...
            {
                void* storage(reinterpret_cast<boost::python::converter::rvalue_from_python_storage<Timpl_>*>(data)->storage.bytes);
    ...
    public:
        ...
        static PyObject* __new__(PyTypeObject* klass, PyObject* arg, PyObject* kwarg)
        {
            ...
            case 6:
                retval = create();
                if (set_position(reinterpret_cast<ParticleWrapper*>(retval), PyTuple_GetItem(arg, 0), 0)
                    || set_radius(reinterpret_cast<ParticleWrapper*>(retval), PyTuple_GetItem(arg, 1), 0)
                    || set_D(reinterpret_cast<ParticleWrapper*>(retval), PyTuple_GetItem(arg, 2), 0)
                    || set_v(reinterpret_cast<ParticleWrapper*>(retval), PyTuple_GetItem(arg, 3), 0)
                    || set_sid(reinterpret_cast<ParticleWrapper*>(retval), PyTuple_GetItem(arg, 4), 0)
                    || set_structure_id(reinterpret_cast<ParticleWrapper*>(retval), PyTuple_GetItem(arg, 5), 0))
                {
        ...
        static PyObject* get_position(ParticleWrapper* self)
        {
            ...
            PyObject* retval = PyArray_New(&PyArray_Type, 1, const_cast<npy_intp*>(dims), peer::util::get_numpy_typecode<typename Timpl_::length_type>::value,
                nullptr, nullptr, 0, NPY_CARRAY, nullptr);
            if (retval == nullptr) return nullptr;
            std::memmove(PyArray_DATA(retval), &pos[0], sizeof(typename Timpl_::length_type) * boost::size(pos));
            return retval;
        }
        ...
        {
            return boost::python::incref(boost::python::object(self->impl_.sid()).ptr());
        }
        ...
        {
            return boost::python::incref(boost::python::object(self->impl_.structure_id()).ptr());
        }
        ...
        static PyObject* __sq_item__(PyObject *self, Py_ssize_t idx)
        {
            ...
            switch (idx)
            {
            case 0: return get_position(reinterpret_cast<ParticleWrapper*>(self));
            case 1: return get_radius(reinterpret_cast<ParticleWrapper*>(self));
            case 2: return get_D(reinterpret_cast<ParticleWrapper*>(self));
            case 3: return get_v(reinterpret_cast<ParticleWrapper*>(self));
            case 4: return get_sid(reinterpret_cast<ParticleWrapper*>(self));
            case 5: return get_structure_id(reinterpret_cast<ParticleWrapper*>(self));
            }
            return nullptr;
        }
        ...
        static int __sq_ass_item__(PyObject *self, Py_ssize_t idx, PyObject *val)
        {
            ...
            switch (idx)
            {
            case 0: return set_position(reinterpret_cast<ParticleWrapper*>(self), val, 0);
            case 1: return set_radius(reinterpret_cast<ParticleWrapper*>(self), val, 0);
            case 2: return set_D(reinterpret_cast<ParticleWrapper*>(self), val, 0);
            case 3: return set_v(reinterpret_cast<ParticleWrapper*>(self), val, 0);
            case 4: return set_sid(reinterpret_cast<ParticleWrapper*>(self), val, 0);
            case 5: return set_structure_id(reinterpret_cast<ParticleWrapper*>(self), val, 0);
            }
