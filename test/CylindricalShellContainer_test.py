...
class CylindricalShellContainerTestCase(unittest.TestCase):
    ...
    def testC1(self):
        ...
        shell_id0 = ShellID()
        c.update((shell_id0, CylindricalShell(DomainID(), Cylinder([500, 500, 500], 50, [0,0,1], 50, ))))
        ...
        c.update((shell_id0, CylindricalShell(DomainID(), Cylinder([500, 500, 500], 50, [0,0,1], 75))))
        d = c.get_neighbors_within_radius([500, 500, 600], 75)
    ...
    def testC3(self):
        shell_id0 = ShellID()
        c = CylindricalShellContainer(1000, 3)
        c.update((shell_id0, CylindricalShell(DomainID(), Cylinder([0, 0, 0], 50, [0,0,1], 50))))
    ...
    def testC4(self):
        shell_id0 = ShellID()
        c = CylindricalShellContainer(1000, 3)
        c.update((shell_id0, CylindricalShell(DomainID(), Cylinder([0, 0, 0], 100, [0,0,1], 100))))
