...
namespace fcdetail
{
    ...
    struct unary_compose_impl
    {
        ...
        unary_compose_impl(Tfun1_ const& f1, Tfun2_ const& f2) : f1_(f1), f2_(f2) {}
    ...
    struct binary_compose_impl
    {
        ...
        binary_compose_impl(Tfun1_ const& f1, Tfun2_ const& f2) : f1_(f1), f2_(f2) {}
        ...
        result_type operator()(first_argument_type const& v1, second_argument_type const& v2)
        {
            return f1_(f2_(v1, v2));
        }
    ...
    struct binary_compose_impl < Tderived_, Tfun1_, Tfun2_, void >
    {
        ...
        void operator()(first_argument_type const& v1, second_argument_type const& v2) const
        {
            f1_(f2_(v1, v2));
        }

        void operator()(first_argument_type const& v1, second_argument_type const& v2)
        {
            f1_(f2_(v1, v2));
        }

        void operator()(first_argument_type& v1, second_argument_type& v2) const
        {
            f1_(f2_(v1, v2));
        }

        void operator()(first_argument_type& v1, second_argument_type& v2)
        {
            f1_(f2_(v1, v2));
        }
...
template < typename Tfun1_, typename Tfun2_ >
inline unary_compose< Tfun1_, Tfun2_ > compose_unary(Tfun1_ const& f1, Tfun2_ const& f2)
{
...
template < typename Tfun1_, typename Tfun2_ >
inline binary_compose< Tfun1_, Tfun2_ > compose_binary(Tfun1_ const& f1, Tfun2_ const& f2)
{
