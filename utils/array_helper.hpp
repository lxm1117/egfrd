...
inline ::boost::array<T_, __n__> array_gen( BOOST_PP_ENUM_PARAMS(__n__, T_ const& p)) \
{ \
...
inline ::boost::array<T_, Nto_ - Nfrom_>& array_slice(::boost::array<T_, Ncap_>& arr)
{
...
inline ::boost::array<T_, Nto_> const& array_slice(::boost::array<T_, Nfrom_> const& arr)
{
