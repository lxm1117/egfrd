...
struct EGFRDSimulatorTraitsBase : public ParticleSimulatorTraitsBase < Tworld_ >
{
    ...
    static const Real MULTI_SHELL_FACTOR;
    static const Real DEFAULT_DT_FACTOR;
    static const Real CUTOFF_FACTOR;
};


template<typename Tworld_> const Real EGFRDSimulatorTraitsBase<typename Tworld_>::SAFETY = 1. + 1e-5;
template<typename Tworld_> const Real EGFRDSimulatorTraitsBase<typename Tworld_>::SINGLE_SHELL_FACTOR = .1;
template<typename Tworld_> const Real EGFRDSimulatorTraitsBase<typename Tworld_>::MULTI_SHELL_FACTOR = .05;
template<typename Tworld_> const Real EGFRDSimulatorTraitsBase<typename Tworld_>::DEFAULT_DT_FACTOR = 1e-5;
template<typename Tworld_> const Real EGFRDSimulatorTraitsBase<typename Tworld_>::CUTOFF_FACTOR = 5.6;
